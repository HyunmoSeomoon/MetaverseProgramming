...
default는 develop branch입니다.

.gitignore을 unity로 설정하여 unity project를 업로드할 수 있습니다.(업로드 하시면 됩니다)

filename이 한글인 경우, bash console에서 unicode를 제대로 표시하지 못해 이상하게 보일 수 있습니다. 신경쓰지 마세요

추가적인 질문이 있으면 연락 주세요

## Developer Rules
1. 모든 개인 작업의 경우 develop branch에서 파생된 다른 branch를 새로 만들어 진행합니다. (덮어쓰기 방지)
